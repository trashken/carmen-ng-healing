...
title_jp: 家・土地の浄化
title_zh: 家居與土地淨化
subtitle_en: Remote Space Clearing
subtitle_jp: 遠隔空間浄化
subtitle_zh: 遠距離空間淨化
desc_en: A space dedicated to clearing energetic stagnation and restoring
  harmony to your home or property.
desc_jp: 住まいや土地に溜まったネガティブなエネルギーや停滞を取り除き、高次の波動で満たします。心地よい調和と安らぎをもたらす、空間のヒーリングです。
desc_zh: 清除居住環境或土地中沉積的負面能量與淤塞，並注入高頻能量，為您的空間帶來深層的諧和與寧靜。
icon: ○
color: sky
order: 4
tagline_en: Restoring balance and peace to your sanctuary.
tagline_jp: 空間の波動を高め、調和と安らぎを取り戻す。
tagline_zh: 提升空間頻率，重拾和諧與平靜。
what_we_do_en: |-
