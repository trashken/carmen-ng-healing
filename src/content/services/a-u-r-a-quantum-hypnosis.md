...
title_jp: ヒプノセラピー
title_zh: 催眠療法
subtitle_en: A.U.R.A. Quantum Hypnosis - Angelic Universal Regression Alchemy
subtitle_jp: A.U.R.A. 量子催眠療法 - エンジェリック・ユニバーサル・レグレッション・アルケミー
subtitle_zh: A.U.R.A. 量子催眠 - 量子回溯及天使鍊金術
desc_en: >
...
intro_en: >
  ...
  remove yourself from the 3D Inverted A.I. Matrix. 


  If you have undergone R.A.A.H. Reiki sessions, A.U.R.A. Quantum Hypnosis will
  help you transcend past and present lives, providing a deeper,
  multi-dimensional purification of the body, mind, and spirit.
intro_jp: |
...
what_we_do_en: >-
  A.U.R.A. Hypnosis facilitates the following aspects of SELF-HEALING during the
  Body Scan:
  ...
  Entity Removal: Clearing negative entity attachments, Reptilian consciousness,
  Archons
  ...
  Illnesses/Diseases/Disorders e.g. Cancer, Tumors, Diabetes, Multiple
  Sclerosis, Epstein-Barr Virus
  ...
  DNA Reprograming and Reparing for enhanced vitality and well-being 


  Energetic Alignment: Balancing and aligning Chakras 


  Issues with Auric field 


  Soul Retrieval: Retrieving fragmented aspects of the soul for integration and
  wholeness 
...
through_session_en: >-
  In typical past life regression sessions, the full connection with the Higher
  Self often occurs midway through the session, after it's officially called
  forth. 


  However, in A.U.R.A. Hypnosis, this connection is established right at the
  beginning through a sacred energy work sound bath. This early connection
  serves to diminish the influence of the ego-mind, allowing for a more seamless
  connection with the Higher Self. Consequently, it enables a deeper journey
  into the exploration of one's infinite creation and facilitates prosperous
  self-healing. 


  Furthermore, if there's difficulty in connecting with the Higher Self for
  Quantum Healing or if a deeper connection is required, Archangels and Ascended
  Masters, in union with the Higher Self, step in to assist, facilitating the
...
through_session_zh: >-
  ...
  但在 A.U.R.A.
  量子催眠則通過神聖能量工作，讓連接一開始就會建立起來。這樣有助減少自我意識的影響，從而達致更無縫的高我連接，更深入探索自己無限的創造力，並促進自我療癒。
