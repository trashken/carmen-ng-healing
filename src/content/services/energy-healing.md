...
serviceBody:
  en: >-
    ...
    alchemy of Light Codes (including Dragons, Seraphim, Kuan Yin, Lemurian
    lineages) and/or RAAH Reiki (Reiki Angelic Alchemy Healing), we will work
  ...
  jp: |-
    ...
    ハイヤーセルフからの導きのもと、現在のニーズに最も効果的なヒーリングをお届けできるよう、すべてのセッションはオーダーメイドされます。ライトコード（龍神様、セラフィム、観音様、レムリアンの系譜を含む）や RAAH霊気（レイキ・エンジェリック・アルケミー・ヒーリング）の神聖なるアルケミーを融合させ、最高善に必要な内容に応じて、以下の1つまたは複数のアプローチを組み合わせて進めていきます：
  ...
  zh: >-
    ...
    在你的高我指引下，每個療程均度身訂造，針對你當下的需求，提供最有效的療癒。我們融合了光編碼（包括龍神、熾天使，觀音菩薩，雷姆利亞的傳承）及/或 RAAH
...
testimonial_1: |-
  まず、大きな変化としては、頭がだいぶクリアになってきました。以前は、朝からあれこれ色々気が散ってしまいようやく夕方から集中できるような酷い状態でしたが、悩むことが少なくなってすべき事に少しずつ集中できていると思います。学習も、仕事探しも、タイミングよく喝を入れてくれる方と出会い、依然、状況はまだ仕事も決まっておらず落ち着かないことに変わりはないのですが、それでも以前よりはましになってきています。
...
offerings:
  - title:
    ...
    desc:
      ...
      jp: |-
        初回セッションは90分を目安に、現在のエネルギー状態やテーマを丁寧に読み解きながら、必要なメッセージとエネルギーヒーリングを総合的に行います。今のご自身の状態を深く理解し、これからの流れを整えていくための大切な土台となるセッションです。

        セッション方法：Zoomによるオンライン（セッションの録画データ付き）  

        事前準備：ご予約後、私からメールにて準備事項をお送りいたします。
      zh: |-
        療程為90分鐘，會細緻解讀您當下的能量狀態與主題，並整合傳遞所需訊息與療癒；助您深入了解自身狀態，為未來調整方向奠定基礎的重要過程。
  ...
  - title:
    ...
    desc:
      en: >-
        ...
        Format: Conducted online via Zoom (Recording included)  
      jp: |-
        2回目以降は、前回から3ヶ月以内のご予約にてご案内しております。継続セッションは、お一人おひとりの状態に応じて、60分で行います。あまり間隔を空けずに継続して受けていただくことで、変化の流れを保ちながら、より深く安定した癒しへとつながっていきます。

        ​心・体・魂に無理のないかたちで、やさしく段階的に整えていくことを大切にしています。はじめての方にも安心して受けていただけるよう、丁寧に進めていきます。

        セッション方法：Zoomによるオンライン（セッションの録画データ付き）  
      zh: |-
        第2次及其後的療程，建議於對上一次療程後3個月內預約。相隔較平均期間持續接受療癒，能逐步深化及穩定療癒效果。每次療程為60分鐘。

        我會循序漸進，讓身心在無壓力情況下適切自然調整。重新連結自身原有的光與潛能，回到最天然、舒適的生命流動之中。
