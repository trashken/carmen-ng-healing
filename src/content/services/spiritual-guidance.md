...
serviceBody:
  en: >+
    ...
    During the session, I will share messages received from your Higher Self
    ...
    experiences or trauma from this lifetime, but also ancestral influences,
  ...
  jp: |+
    ...
    セッションの前に、事前にご質問やガイダンスを受け取りたいテーマをお送りいただきます。

    セッション当日は、あなたのハイヤーセルフやスピリットガイド（守護霊）からのメッセージをお伝えし、さらに聖なる源（ディヴァイン）からのインサイトをチャネリングしてお届けします。 

    必要に応じて「アカシックレコード」にアクセスし、多次元的な視点から、あなたが現在直面している課題や不調調和の根本原因を探るなど、今のあなたにとって最も重要な魂の記録（知恵）を受け取ります。これは、今世の経験やトラウマだけでなく、ご先祖様からの影響、カルマのテーマ、過去世や未来のタイムラインとの繋がりまで含まれる場合があります。

    所要時間: 60分

    形式: Zoomによる遠隔セッション（レコーディング付き）

    事前準備の詳細については、ご予約後にお送りいたします。
  ...
  zh: |+
    ...
    療程中，我將為您傳遞來自高我（Higher Self）及/或守護靈的訊息，協助深層覺察。

    如有需要，我們會連結您的阿卡西紀錄（Akashic Records），從靈魂記錄中擷取對您當下最重要的智慧。我們會從靈性與能量的多維度視角，探討您面臨挑戰或失衡的根本原因；這不僅涵蓋今生的經歷與創傷，亦可能涉及家族傳承的影響、業力課題，以及與前世或未來時間線的連結。當需要時，我會針對這些層面進行能量調整，引導您的生命能量回歸到最原本、最自然的狀態。
...
testimonial_1: |-
  ...
  ~ kao
testimonial_2: >-
  自分が疑問に思っている事への解答を高次の存在から受け取るとはこういう事をいうのか、と何となくではありますが感覚としてわかるようになってきた気がします。
...
offerings:
  - title:
    ...
    desc:
      ...
      jp: |-
        1回のセッションでは、事前にお手元にご用意いただいたご質問を、目安として4〜6問ほどお答えしていきます。

        セッション方法：Zoomによるオンライン（セッションの録画データ付き）

        事前準備：ご予約後、私からメールにて準備事項をお送りいたします。
      zh: |-
        每個療程大概能解答 4 至 6 條你預備好的問題。
