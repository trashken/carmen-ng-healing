...
subtitle:
  en: Guidance from Higher Self & Spirit Guides
  jp: ハイヤーセルフとスピリットガイドからの導き
  zh: 來自高我及守護靈的指引
desc:
  en: |
    A channeling session for the mind, body, and soul, combining guidance from your Higher Self and/or Spirit Guides with the energy alignment you need in the present moment. 
  jp: |
...
intro:
  en: |
    This is a holistic healing session for the mind, body, and soul, combining guidance from your Higher Self with the energy alignment you need in the present moment.
  jp: |
...
serviceBody:
  en: |-
    ...
    Before the session, you are invited to send in your questions or areas you would like guidance on. 

    During the session, I will share messages received from your Higher Self and/or Spirit Guides, and channel any further insights from the Divine. 

    When needed, I may also access the Akashic Records, receiving wisdom from your soul's records that is most relevant for you at this time, such as exploring the root causes behind any challenges or imbalances you may be experiencing from a multidimensional perspective. This may include not only experiences or trauma from this lifetime, but also ancestral influences, karmic themes, and connections to past or future timelines. 
  ...
  jp: |-
    ...
    セッション前には、あなたが導きを求めている具体的な質問やテーマをお送りいただけます。

    セッション中は、あなたのハイヤーセルフやスピリットガイドから受け取ったメッセージをお伝えし、さらには高次元（Divine）からの洞察をチャネリングします。

    必要に応じて、アカシックレコードにアクセスし、今この瞬間のあなたにとって最も重要な知恵を読み解きます。直面している課題や不調の根本的な原因を、多次元的な視点から紐解いていきます。これには、今世の経験やトラウマだけでなく、先祖からの影響、カルマのテーマ、そして過去や未来のタイムラインとの繋がりも含まれます。
